...
#define DATA_SIZE 6
	...
	enum animal_type input_data[] = { FOX, DOG, COW, PIG, ANIMAL_TYPE_COUNT, ANIMAL_TYPE_COUNT + 1 };
	char *expected_values[] = { "Лисица", "Собака", "Корова", "Свиня", "N/A", "N/A" };
...
#define EXPERIMENTS_COUNT 10
	...
	for (int i = 0; i < EXPERIMENTS_COUNT; i++) {
		...
		if (strcmp(get_animal_type_name(actual_data.type), "N/A") == 0) {
